...
export const settings = {
  readOptions: {
    ...
    "port": process.env.READ_DB_CONNECTION_PORT ? parseInt(process.env.READ_DB_CONNECTION_PORT) : 5432,
  ...
  writeOptions: {
    ...
    "port": process.env.WRITE_DB_CONNECTION_PORT ? parseInt(process.env.WRITE_DB_CONNECTION_PORT) : 5432,
    "ssl": { "rejectUnauthorized": false },
  },
